...
class AppConfig {
  static String copyright_text = "@ Uvicol " + this_year; //this shows in the splash screen
  static String app_name = "Uvicol Delivery App"; //this shows in the splash screen
