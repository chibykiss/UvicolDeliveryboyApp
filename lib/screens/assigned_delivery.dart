    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            child: deliveryPoints.length>0?InkWell(
              splashColor: Colors.white,
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>MultiOrderMap(orders: deliveryPoints)));
              },
              child: Row(
                children: [
                  Text("Get locations",style: TextStyle(
                      fontSize: 14,
                      color: MyTheme.blue,
                      fontWeight: FontWeight.w600)),
                  SizedBox(width: 5,),
                  Icon(Icons.location_on,color: MyTheme.blue,size: 20,),
                ],
              ),
            ):Container(),
          )
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      if(!_list[index].location_available ){
                        ...
                        ToastComponent.showDialog("Location not available", context,
                            gravity: Toast.center, duration: Toast.lengthLong);
                        return;
                      }
